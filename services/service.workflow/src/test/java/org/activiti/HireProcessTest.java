...
public class HireProcessTest {
	...
	public void testHappyPath() {
		...
		Task task = taskService.createTaskQuery().processInstanceId(processInstance.getId()).taskCandidateGroup("dev-managers").singleResult();
		...
		// Completing both should wrap up the subprocess, send out the 'welcome mail' and end the process
		// instance
