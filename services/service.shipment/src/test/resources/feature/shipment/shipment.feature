...
Scenario: As admin I want to add a new shipment 
	When I request to add a shipment 
		| shipmentId | dimensions   |  
		| 0  | 300x440x500 | 
	Then the response code should be 201 
	And the response should contain a shipment 
	And the shipment dimensions should be "300x440x500" 
...
Scenario: As admin I want to update a shipment 
	...
	And  the response should contain a shipment 
	And  the shipment dimensions should be "600x440x500"

Scenario: As admin, I get an error when I want to update a non-existing shipment
...
Scenario: As admin, I get an error when I want to get a non-existing shipment
	When  I request to get a shipment by ID 999999
	Then  the response code should be 404
